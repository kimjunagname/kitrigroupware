...
public class OrganizationDto {
	...
	public String getAdmn_sq() {
		return admn_sq;
	}
	public void setAdmn_sq(String admn_sq) {
	...
	public String getStf_bs_ph() {
		return stf_bs_ph;
	}
	public void setStf_bs_ph(String stf_bs_ph) {
		this.stf_bs_ph = stf_bs_ph;
	}
