...
<script type="text/javascript" src="${root}/easyui/jquery.easyui.min.js"></script>
							...
							<tbody>
								...
								<tr>
									...
									<td><textarea id="eml_cnt1" readonly="readonly" rows="10"
											style="width: 100%;">${emailDto.eml_cnt}</textarea></td>
								</tr>
								<tr>
									<th>보낸사람</th>
									<td id="stf_nm1">${emailDto.stf_snd_sq}</td>
								</tr>
								<tr>
									<th>받은시간</th>
						...
						<section class="panel"> 
							...
							<div class="panel-body minimal">
								...
								<div class="table-inbox-wrap ">
									...
									<tbody>
									<c:forEach items="${keepList}" var="emailDto">
										<tr valign="middle">
	...
	$(document).ready(function () {
		...
		function emailRead(eml) {
			...
			$.ajax({
				url: "${root}/email/emailKeepRead.kitri",
				type: "POST",
				dataType: "json",
			    data : JSON.stringify(params),
			    contentType: "application/json; charset=UTF-8",
