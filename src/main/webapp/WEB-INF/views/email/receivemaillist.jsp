							...
							<header class="panel-heading wht-bg">
								...
								<form id="rightTop" class="pull-right mail-src-position">
									<div>
										...
										<select id="cate" style="width: 60px; height: 30px; font-size: 16px;" class="inp">
											<option value="1">작성자</option>
											<option value="2">이름</option>
										</select> 
										<span> 
											<input type="text" id="keyword" size="22" class="inp" style="margin-top: -19px;">
										</span> 
										<span>
											<button class="btn btn-success btn-sm" id="search" type="button">검색</button>
										</span>
