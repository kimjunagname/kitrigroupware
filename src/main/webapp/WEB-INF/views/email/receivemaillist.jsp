					...
					<form role="form" id="frm" method="post" action="/email/register"
						...
						<table id="list" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									<th>내용(*)</th>
									<td><textarea id="eml_cnt" style="resize: none;"
											width: 100%" name="eml_cnt" rows="10" class="form-control">
										</textarea></td>
								</tr>
								<tr>
									...
									<td>
										<div class="col-xs-4">
											<input type="text" id="stf_rcv_email" name="stf_rcv_email"
												class="form-control">
										</div>
									</td>
								</tr>
								<tr>
									<th>파일첨부</th>
									<td><input type="file" id="eml_pl_crs" name="file"
							...
							<tbody>
								...
								<tr>
									...
									<td><textarea id="eml_cnt1" readonly="readonly" rows="10"
											style="width: 100%; resize: none;">여기는 내용입니다.</textarea>
									<td>
								</tr>
								<tr>
									<th>보낸사람</th>
			...
			<div class="col-sm-20 mail-w3agile">
				...
				<h4 class="gen-case">
					...
					<form action="#" class="pull-right mail-src-position">
						<div>
							<span>
								<button class="btn btn-primary btn-sm" id="send" type="button"
									data-toggle="modal" data-target="#insertModal">메일작성</button>
							</span> <span>
								<button class="btn btn-danger btn-sm" id="deleteBtn"
									type="button">체크 메일 삭제</button>
							</span> <select name="item"
								style="width: 60px; height: 30px; font-size: 16px;" class="inp">
								<option value="subject">제목
								<option value="writer">이름
							</select> <span> <input type="text" name="query" size="22"
				...
				<div class="panel-body minimal">
					<div class="table-inbox-wrap ">
						<table class="table table-inbox table-hover">
							<tbody id="mail list">
								<tr class="">
									<td class="inbox-small-cells"><input type="checkbox" class="check"></td>
									<td class="view-message  dont-show"><a href="#">ABC Company</a></td>
									<td class="view-message ">
									<a href="#" data-toggle="modal" class="eml_rd" data-value="" data-target="#readModal">Loremipsumdolor imit set.</a></td>
								...
								<tr class="">
									...
									<td class="view-message dont-show"><a href="#">Mr Bean</a>
									</td>
									<td class="view-message"><a href="#">Hi Bro, Lorem
											ipsum dolor imit</a></td>
									<td class="view-message inbox-small-cells"></td>
								...
								<tr class="">
									<td class="inbox-small-cells"><input type="checkbox"
										class="mail-checkbox"></td>
									<td class="view-message dont-show"><a href="#">Jonathan
											Smith</a></td>
									<td class="view-message"><a href="#">Lorem ipsum
											dolorsit amet</a></td>
									<td class="view-message inbox-small-cells"></td>
								...
								<tr class="">
									<td class="inbox-small-cells"><input type="checkbox"
										class="mail-checkbox"></td>
									<td class="view-message dont-show"><a href="#">Facebook</a>
									</td>
								...
								<tr class="">
									<td class="inbox-small-cells"><input type="checkbox"
										class="mail-checkbox"></td>
									<td class="view-message dont-show"><a href="#">Tasi
											man </a></td>
									<td class="view-message"><a href="#">Lorem ipsum dolor
											sit amet</a></td>
									<td class="view-message inbox-small-cells"></td>
