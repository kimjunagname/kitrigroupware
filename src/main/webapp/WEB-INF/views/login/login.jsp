...
<div class="w3layouts-main">
	...
	<br> 
		...
		<form action="#" method="post" class="ns">						
			<input id="email" type="text" class="form-control ggg" name="email" placeholder="ID">
			<input id="password" type="password" class="form-control ggg" name="password" placeholder="PASSWORD">
			<span><input type="checkbox" /> 아이디 저장</span>
			<h6><a href="idfind.html">아이디</a> 또는 <br>
			<a href="pwfind.html">비밀번호</a> 찾기</h6>
				<div class="clearfix"></div>
				<input type="button" value="LOGIN" name="login">
		</form>
		<p class="ns">아직 계정이 없으신가요?<a href="registration.html">회원가입</a></p>
</div>
</div>
